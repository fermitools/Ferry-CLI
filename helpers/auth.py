...
__all__ = ["DEFAULT_CA_DIR", "get_default_token_path", "get_default_cert_path", "AuthToken", "AuthCert"]
...
class AuthCert(object):
    ...
    auth"""
    def __init__(self: 'AuthCert', cert_path: str = get_default_cert_path(), ca_path: str = DEFAULT_CA_DIR) -> None:
